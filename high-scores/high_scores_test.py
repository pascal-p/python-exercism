...
class HighScoresTest(unittest.TestCase):
    ...
    def test_latest_when_scores_is_empty(self):
        with self.assertRaisesWithMessage(Exception,
                                          f"function should raise exception"):
            latest([])
    ...
    def test_personal_best_when_scores_is_empty(self):
        with self.assertRaisesWithMessage(Exception,
                                          f"function should raise exception"):
            personal_best([])
    ...
    def test_personal_top_when_there_is_none(self):
        with self.assertRaisesWithMessage(Exception,
                                          f"function should raise exception"):
            personal_top_three([])
