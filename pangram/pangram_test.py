...
class PangramTest(unittest.TestCase):
    ...
    def test_mixed_case_sentence_without_upper_bound(self):
        self.assertIs(is_pangram("ab CD E f g hi JKLM no  pq    rs t U V W x y "), False)

    def test_sentence_mixed_case_punctuation_etc(self):
        self.assertIs(is_pangram("Higher Order Functions [HOF] in Python: map, filter, sorted, reduce... or (FP) at play"),
                      False)
