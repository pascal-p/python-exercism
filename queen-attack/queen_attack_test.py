...
class QueenAttackTest(unittest.TestCase):
    ...
    def test_can_not_attack1(self):
        self.assertIs(Queen(2, 4).can_attack(Queen(6, 6)), False)

    def test_can_not_attack2(self):
        self.assertIs(Queen(6, 3).can_attack(Queen(4, 4)), False)

    def test_can_not_attack3(self):
        self.assertIs(Queen(4, 4).can_attack(Queen(6, 3)), False)

    def test_can_not_attack4(self):
        self.assertIs(Queen(7, 0).can_attack(Queen(5, 1)), False)
    ...
    def test_can_attack_on_down_full_diagonal(self):
        self.assertIs(Queen(0, 0).can_attack(Queen(7, 7)), True)

    def test_can_attack_on_up_full_diagonal(self):
        self.assertIs(Queen(7, 0).can_attack(Queen(0, 7)), True)

    def test_can_attack_on_same_diagonal_nextpos1(self):
        self.assertIs(Queen(7, 0).can_attack(Queen(6, 0)), True)

    def test_can_attack_on_same_diagonal_nextpos1(self):
        self.assertIs(Queen(0, 7).can_attack(Queen(1, 6)), True)
