...
class ChangeTest(unittest.TestCase):
    ...
    def test_large_target_values_1(self):
        self.assertEqual(
            find_fewest_coins([1, 2, 5, 10, 20, 50, 100], 999),
            [2, 2, 5, 20, 20, 50, 100, 100, 100, 100, 100, 100, 100, 100, 100]
        )

    def test_large_target_values_2(self):
        self.assertEqual(
            find_fewest_coins([1, 2, 5, 10, 20, 50, 100, 500], 1999),
            [2, 2, 5, 20, 20, 50, 100, 100, 100, 100, 500, 500, 500]
        )

    def test_large_target_values_3(self):
        self.assertEqual(
            find_fewest_coins([1, 2, 5, 10, 20, 50, 100, 500], 10999),
            [2, 2, 5, 20, 20, 50, 100, 100, 100, 100, *[500 for _ in range(21)]]
        )

    def test_large_target_values_4(self):
        self.assertEqual(
            find_fewest_coins([1, 2, 5, 10, 20, 50, 100, 500], 20999),
            [2, 2, 5, 20, 20, 50, 100, 100, 100, 100, *[500 for _ in range(41)]]
        )
